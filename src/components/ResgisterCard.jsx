...
function RegisterCard () {
  return (
    <section className='flex justify-left items-center h-200px md:h-[500px] lg:h-[50vh] lg:w-[50vw] bg-purple-500 relative md:rounded-xl overflow-hidden'>
      <img className='w-full h-full absolute' src={image} alt='Image banner' />
      <div className='flex flex-col justify-center gap-10 px-20 relative font-light h-full w-full text-3xl md:text-5xl bg-opacity-60 text-white bg-black'>
